...
<div x-data="stressPersonEncyclopediaListApp()" x-init="init()" x-cloak>
    <div class="space-y-3">
            ...
            >
                <div class="p-4">
                    <div class="flex items-start justify-between gap-3 mb-2">
                        ...
                        <span class="text-xs text-emerald-600 font-medium whitespace-nowrap" x-text="formatDate(item.created_at)"></span>
                    </div>
        ...
        <div x-show="!loading && entries.length === 0" class="text-center py-12 text-gray-500">
            ...
            <p>まだ記録がありません</p>
            <a href="/stress-person-encyclopedias" class="text-teal-600 hover:text-teal-800 text-sm mt-4 inline-block">
                ストレス人物図鑑を作成してみましょう →
            </a>
        </div>
    </div>
