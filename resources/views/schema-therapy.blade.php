...
$features = [
    ...
    [
        'href' => '/schema-therapy/self-monitoring',
        'title' => 'スキーマとモードのセルフモニタリング',
        'icon' => '<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-full h-full">
    ...
    [
        'href' => '/schema-therapy/happy-schema-map',
        'title' => 'ハッピースキーママップ',
        'icon' => '<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-full h-full">
    ...
    [
        'href' => '/schema-therapy/healthy-schema-dialogue',
        'title' => 'ヘルシーサイドとスキーマサイドの対話のワーク',
        'icon' => '<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-full h-full">
            ...
            <path d="M12 10H12.01" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
            <path d="M16 10H16.01" stroke="currentColor" stroke-width="2" stroke-linecap="round"/>
        </svg>',
    ],
    [
        'href' => '/schema-therapy/happy-schema-action-plan',
        'title' => 'ハッピースキーマと行動計画',
        'icon' => '<svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-full h-full">
