...
<div class="max-w-4xl mx-auto grid grid-cols-2 gap-3 sm:gap-4 md:gap-6">
    ...
    <!-- Self Compassion Journal Card -->
    <a href="/self-compassion-journals" class="block group">
        <div class="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 md:p-8 border border-gray-200 hover:shadow-xl transition-all duration-300 hover:scale-105 h-full">
            <div class="flex flex-col items-center text-center">
                <div class="w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16 mb-3 sm:mb-4 md:mb-6 text-green-600">
                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-full h-full">
                ...
                <h2 class="text-sm sm:text-base md:text-xl lg:text-2xl font-bold text-gray-900">セルフコンパッション日記</h2>
            </div>
        </div>
    </a>

    <!-- Stress Person Encyclopedia Card -->
    <a href="/stress-person-encyclopedias" class="block group">
        <div class="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 md:p-8 border border-gray-200 hover:shadow-xl transition-all duration-300 hover:scale-105 h-full">
            <div class="flex flex-col items-center text-center">
                <div class="w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16 mb-3 sm:mb-4 md:mb-6 text-green-600">
                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-full h-full">
                ...
                <h2 class="text-sm sm:text-base md:text-xl lg:text-2xl font-bold text-gray-900">ストレス人物図鑑</h2>
            </div>
        </div>
    </a>
    ...
    <a href="/mindfulness" class="block group">
        <div class="bg-white rounded-xl sm:rounded-2xl shadow-lg p-4 sm:p-6 md:p-8 border border-gray-200 hover:shadow-xl transition-all duration-300 hover:scale-105 h-full">
            <div class="flex flex-col items-center text-center">
                <!-- Mindfulness Icon (lotus / meditation) -->
                <div class="w-10 h-10 sm:w-12 sm:h-12 md:w-16 md:h-16 mb-3 sm:mb-4 md:mb-6 text-green-600">
                    <svg viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" class="w-full h-full">
                ...
                <h2 class="text-sm sm:text-base md:text-xl lg:text-2xl font-bold text-gray-900">マインドフルネス瞑想</h2>
            </div>
        </div>
    </a>
