    ...
    <div class="bg-white rounded-xl shadow-md p-4 mb-4">
        ...
        <div class="mt-3 pt-3 border-t border-gray-200 flex justify-between items-center">
            ...
            <button
                ...
                class="inline-flex items-center gap-2 px-4 py-2 bg-white border border-gray-300 rounded-lg text-gray-700 hover:bg-gray-50 hover:border-amber-400 transition-all text-sm font-medium disabled:opacity-50 disabled:cursor-not-allowed"
            >
