...
このプロジェクトは、日々の達成感を味わいながら、心の健康もサポートするWebアプリケーションです。
もともとはTODOリスト機能のみを想定していましたが、現在は認知行動療法（CBT）やコーピングリストなど、メンタルヘルスをサポートする心理療法機能も含まれています。

### 主な機能

#### 1. TODO管理機能
- 日々のタスクを管理し、達成感を味わえるTODOリスト
- タグと難易度によるタスクの分類
- 完了タスクの振り返りと統計表示
- ゴール設定ではなく、作業の積み重ねを実感できる設計
